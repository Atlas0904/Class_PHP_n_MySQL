 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'Gj.AN/[=XC)@)tg 1J|cWF3=~p<6fP(&nXO:=VDv$`%;~k,1aJ*h6bKXTej{)32j');
define('SECURE_AUTH_KEY',  'QMmBt_}E.DuQki2N&|_-+Ak:r}!<b_q[Ju+2hzCkIstSgv9LHGOG6!Zi).;adU,Z');
define('LOGGED_IN_KEY',    '%d8Z;t8KSL?|LVUpC2| D4:CHHM:i_HP1eN#s6(+9(./swV-@~2xH6b*L?D%Y&uP');
define('NONCE_KEY',        'AWOZ{gdfvEDV${,X uG|=hSTg72wqN@w^-QK*xDh5uu+fIVo^O%Y`=u(V*56B8]^');
define('AUTH_SALT',        '6?4kZ4e1:Y^A=Kp&}~d&pL+H`4:h{QmmYAo.Mu(?4@]XE64<rrn@iE|IU$9*^/$N');
define('SECURE_AUTH_SALT', '2_h[D:{Up<h!r1Sc>d@u]oHupbioM45gPY;x19/?z|;v+@5QPvIV+M_d=i^l`1-S');
define('LOGGED_IN_SALT',   '/Moz>Gh9D`3C+{D3]aP:@[fGI]5+/?I;Q)Sv19?/aON.QKT>-R8uuyDH {@fX[tA');
define('NONCE_SALT',       '}Pg$6D,<+2Pg2$V$K@z:4#,dL.ZDn*jHXyZD$b`J4xz<Bx;kP^LK<~67<bKyYCpa');
